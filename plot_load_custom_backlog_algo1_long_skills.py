...
ax1.set_title("Backlog, Synthetic data, Max ordering = 3, Real timezones (-4,0,3,5), Algorithm 1",**params.title_font)    
...
plt.savefig('load_custom_backlog_algo1_long_skills.pdf', format='pdf')
