...
ax1.set_title("TAT, Synthetic data, Max ordering = 3, Real timezones (-4,0,3,5), Algorithm 3",**params.title_font)    
...
plt.savefig('load_custom_tat_algo3_long_skills.pdf', format='pdf')
