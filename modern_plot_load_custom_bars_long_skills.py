...
#ax1.set_title("TAT, Synthetic data, long skills",**params.title_font)   
...
ax1.bar(machines_p[2]+off8-0.1, y_mean_500[2]+1, width*1.8, color='w',linewidth=2, edgecolor='w',bottom=29000)
...
ax1.bar(machines_p[2]+off12-0.1, y_mean_500[2]+1, width*1.8, color='w',linewidth=2, edgecolor='w',bottom=33000)
ax1.text(machines_p[2]+off12+0.1, 33500, '151658', ha='center', va='bottom', fontsize=14)

ax1.bar(machines_t[2]+off12-0.1, y_mean_700[2]+1, width*1.8, color='w',linewidth=2, edgecolor='w',bottom=31000)
...
plt.tight_layout()
plt.savefig('modern_load_custom_bars_long_skills.pdf', format='pdf')
